...
const Home = () => {
  ...
  const features = [
    {
      ...
      description: 'List your plastic waste inventory and connect with verified recyclers. Get competitive prices for PET, HDPE, PVC, and more.'
    },
    {
      icon: '🔄',
      title: 'Buy Recyclable Materials',
      description: 'Access a marketplace of quality plastic materials. Source sustainable inputs for your manufacturing needs.'
    },
    {
      icon: '🌱',
      title: 'Track Environmental Impact',
      description: 'Monitor your contribution to plastic waste reduction. See real-time data on CO₂ saved and materials recycled.'
    }
  ];
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl sm:text-2xl text-gray-200 mb-12 max-w-3xl mx-auto opacity-0 animate-fadeInUp delay-200">
            India's first circular marketplace connecting waste generators with recyclers. 
            Transform environmental responsibility into economic opportunity.
          </p>
          ...
          <div className="mt-20 grid grid-cols-2 lg:grid-cols-4 gap-6 max-w-4xl mx-auto opacity-0 animate-fadeIn delay-500">
            <div className="glass rounded-2xl p-6 text-center">
              <div className="text-3xl font-bold text-white mb-1">{mockStats.totalWeight}</div>
              <div className="text-sm text-gray-300">Plastic Recycled</div>
            </div>
            <div className="glass rounded-2xl p-6 text-center">
              <div className="text-3xl font-bold text-white mb-1">{mockStats.co2Saved}</div>
              <div className="text-sm text-gray-300">CO₂ Emissions Saved</div>
            </div>
            <div className="glass rounded-2xl p-6 text-center">
              <div className="text-3xl font-bold text-white mb-1">24/7</div>
              <div className="text-sm text-gray-300">Marketplace Active</div>
            </div>
            <div className="glass rounded-2xl p-6 text-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              A simple, transparent platform for buying and selling plastic waste. 
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Real-time metrics showing our collective impact on plastic waste reduction
            </p>
          </div>
      ...
      {/* About Section */}
      <section id="about" className="py-24 bg-gradient-to-br from-olive-50 to-white relative overflow-hidden">
        {/* Decorative circles */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="opacity-0 animate-fadeInUp">
              ...
              <p className="text-xl text-gray-700 mb-6 leading-relaxed">
                PlasticProfit exists to solve India's plastic waste crisis by creating 
                a transparent marketplace that makes recycling profitable and accessible 
                for everyone.
              </p>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                We're connecting waste generators with recyclers to reduce plastic 
                pollution, create economic opportunity, and build a truly circular 
                economy. Every transaction on our platform represents plastic waste 
                diverted from landfills and oceans.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-black mb-1">Verified Network</h3>
                    <p className="text-gray-600">All buyers and sellers are thoroughly vetted</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-black mb-1">Transparent Pricing</h3>
                    <p className="text-gray-600">Real-time market rates for all plastic types</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-black mb-1">Impact Tracking</h3>
                    <p className="text-gray-600">Measure your environmental contribution</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative opacity-0 animate-fadeInUp delay-200">
              ...
              <div className="absolute -bottom-8 -left-8 bg-white rounded-2xl p-6 shadow-2xl animate-float">
                <div className="text-3xl font-bold text-olive-600 mb-1">500+</div>
                <div className="text-sm text-gray-600">Tonnes Recycled</div>
              </div>
              
              <div className="absolute -top-8 -right-8 bg-white rounded-2xl p-6 shadow-2xl animate-float" style={{ animationDelay: '1s' }}>
                <div className="text-3xl font-bold text-olive-600 mb-1">15K+</div>
      ...
      <section className="py-24 bg-black text-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          ...
          <p className="text-xl text-gray-300 mb-12">
            Join hundreds of businesses already using PlasticProfit to turn waste into value
          </p>
