...
const Marketplace = () => {
  ...
  const handleMakeOffer = (offerData) => {
    ...
    const existingOffers = JSON.parse(localStorage.getItem('plasticProfitOffers') || '[]');
    ...
    localStorage.setItem('plasticProfitOffers', JSON.stringify(existingOffers));
    
    // Show success message
    alert(`Offer of ₹${offerData.offerPrice}/kg submitted successfully! Check your dashboard to track it.`);
  };
